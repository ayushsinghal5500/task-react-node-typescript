...
import { Mail, Lock, Eye, EyeOff, LogIn, BookOpen, Users, Brain, Sparkles } from "lucide-react";
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-8 bg-gradient-to-br from-blue-600 to-indigo-700 text-white">
        <div className="max-w-md">
          ...
          <p className="text-xl mb-8 text-blue-100">
            Continue your journey of learning and growth with our community of students and mentors.
          </p>
        ...
        <div className="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden transform transition-all duration-300 hover:shadow-2xl">
          <div className="p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <a href="/forgot-password" className="text-sm text-blue-600 hover:text-blue-800 transition duration-200">
                    Forgot password?
                  </a>
                </div>
                <div className="relative">
            ...
            <p className="mt-8 text-center text-sm text-gray-600">
              ...
              <a href="/register" className="font-medium text-blue-600 hover:text-blue-800 transition duration-200">
                Sign up now
              </a>
            </p>
          </div>
